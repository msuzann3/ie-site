const NEWSLETTER_URL = 'https://flowandfunction.beehiiv.com'
      ...
      <div className="max-w-[1180px] mx-auto rounded-[24px] overflow-hidden bg-midnight text-white grid grid-cols-1 md:grid-cols-[1fr_auto] md:items-center gap-8 px-7 py-10 md:px-12 md:py-12">
        <div>
          ...
          <p className="text-[15px] md:text-[16px] text-white/65 font-light leading-[1.75] max-w-[680px]">
            Flow &amp; Function is Michelle&apos;s newsletter about making AI useful at work:
            practical strategy, learning, governance, and change for people turning emerging
            technology into working practice. Each week includes one practical workflow to test
            and build.
          </p>
        </div>
        <a
